...
<div class="logintop">    
    ...
    <form action="UserServlet" method="post">
	    ...
	    <ul>
	    <li><input name="uid" type="text" placeholder="账号" class="loginuser" /></li>
	    <li><input name="upwd" type="password" placeholder="密码" class="loginpwd" /></li>
	    <!--  <li class="yzm">
    ...
    <div class="loginbm">版权所有  Huang 仅供学习交流，勿用于任何商业用途</div>
